...
| `calibration` | versioned `ParameterSet` (active scoring tunables) + `ParametersService`; foundation for spec 002 auto-calibration/learning | see [[0005-versioned-parameter-sets\|ADR-0005]] |
