...
| `../../specs/005-listing-lifecycle-rechecks/spec.md` | Re-check active listings by score proximity and seller behavior so meaningful price cuts are re-scored and alerted | Draft (formalized 2026-07-28; implementation waits for the SPEC-009 evidence gate and operator approval) |
