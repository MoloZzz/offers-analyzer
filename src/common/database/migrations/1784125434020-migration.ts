...
export class Migration1784125434020 implements MigrationInterface {
    name = 'Migration1784125434020'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "search_profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "sourceKey" character varying NOT NULL DEFAULT 'auto-ria', "categoryId" integer NOT NULL, "stateId" integer, "cityId" integer, "filters" jsonb NOT NULL, "priceFrom" integer, "priceTo" integer, "currency" "public"."search_profiles_currency_enum" NOT NULL DEFAULT 'USD', "discountThresholdPct" numeric(5,2) NOT NULL, "confidenceMinSamples" integer NOT NULL, "dealerPolicy" character varying NOT NULL DEFAULT 'label', "enabled" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_79b8fdf6b0328671778f53ec84b" PRIMARY KEY ("id"))`);
